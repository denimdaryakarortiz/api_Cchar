...
namespace api_app_2.Data
{
    public class ConexionBD
    {
        ...
        private bool AbrirConexion()
        {
            try
            {
                // strCadenaCnx = "Data Source=ARMDFPCCIFSD017\\SQLEXPRESS;Initial Catalog=DB_api_datos; Integrated Security = True";
                strCadenaCnx = "workstation id=BD3680VRS.mssql.somee.com;packet size=4096;user id=valen_ramirez_SQLLogin_3;pwd=cupjpf3af8;data source=BD3680VRS.mssql.somee.com;persist security info=False;initial catalog=BD3680VRS";
        ...
        internal bool ejecutarsentencia(string sentencia, bool v)
        {
